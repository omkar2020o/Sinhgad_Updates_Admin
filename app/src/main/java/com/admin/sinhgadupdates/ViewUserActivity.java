...
import com.admin.sinhgadupdates.adapter.ViewUserAdapter;
...
public class ViewUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView=findViewById(R.id.vua_recyclerView);
        ...
        mReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new ViewUserAdapter(getApplicationContext(), userList, ViewUserActivity.this);
                recyclerView.setAdapter(adapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ViewUserActivity.this, "Failed to load blog, try again later.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}